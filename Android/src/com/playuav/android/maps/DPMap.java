...
public interface DPMap {
	...
	public static final float DEFAULT_LATITUDE = (float)32.6970459;

	public static final String PREF_LNG = "pref_map_lng";
	public static final float DEFAULT_LONGITUDE = (float)105.2894305;
     ...
     * @param listener
     */
    public void setLocationListener(LocationReceiver listener);
